/*
	...
	You will be given four different variables of different data types: a (int), b (float), c (double), l (long long), d (string).
	Your task is to do step-wise operations as given below:
	1. Divide b by c.
	2. Divide b by a.
...
void dataType(int , float , double , long long, string);

void dataType(int a, float b, double c, long long l, string d){
